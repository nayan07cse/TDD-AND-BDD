...
Welcome to the Factories and Fakes. You often need fake data to test against. You can, of course, use some "hard coded" sample data in your tests. But what if you need hundreds of records, or even thousands of records of test data? That can get tedious to create and maintain.

In this we're going to see how to use a popular Python package called **FactoryBoy** to provide fake data for testing.
...
Let's start by installing the required Python packages for this:
